...
const AvailabilityLocationStep = ({ formData, onChange }) => {
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-bold text-blue-700 mb-2 flex items-center gap-2">Availability & Location <span className="text-blue-400" title="Set when and where">📅</span></h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium text-blue-900 mb-1">Available To</label>
          <input
            type="date"
            className="w-full px-4 py-2 border rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
      ...
      <div>
        <label className="block text-sm font-medium text-blue-900 mb-1">Pickup Location</label>
        <input
          type="text"
          className="w-full px-4 py-2 border rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
      ...
      <div className="flex items-center gap-2 mt-4">
        <input
          ...
          id="delivery"
        />
        <label htmlFor="delivery" className="text-sm font-medium text-blue-900">Delivery Available?</label>
      </div>
      {formData.delivery && (
        <div className="mt-2">
          <label className="block text-sm font-medium text-blue-900 mb-1">Shipping Charges</label>
