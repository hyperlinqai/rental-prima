...
CREATE TABLE public.users (
  ...
  user_type TEXT NOT NULL CHECK (user_type IN ('super_admin', 'owner', 'customer')),
...
VALUES 
  ('admin', 'Administrator with full access', '{"all": true}'::jsonb, true, 'active'),
  ('customer', 'Regular customer with limited access', '{"listings": {"read": true}, "categories": {"read": true}}'::jsonb, true, 'active'),
  ('manager', 'Manager with moderate access', '{"users": {"read": true}, "listings": {"read": true, "create": true, "update": true}, "categories": {"read": true}}'::jsonb, false, 'active');
...
VALUES 
  ('Apartments', 'Apartment rentals including flats and condos', 'active'),
  ('Houses', 'Full house rentals including villas and cottages', 'active'),
  ('Commercial', 'Commercial properties for business use', 'active');

-- Insert sample settings
INSERT INTO public.settings (key, value)
VALUES ('site_name', 'Rental Prima');
